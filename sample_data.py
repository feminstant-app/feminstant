...
with app.app_context():
    items = [
        ...
        Item(name='OrganiCup, Size A, Menstrual Cup, 1 unit', quantity=57, price=20.00, department='Feminine Hygiene', description='Can be worn for up to 12 hours')
    ]
    ...
    customers = [
        Customer(name='ASmith', email='alanas@gmail.com', password='password'),
        Customer(name='WEdwards', email='wintae@gmail.com', password='password'),
    ]
